...
export const Footer = () => {
  return (
    <footer className="flex flex-col md:flex-row justify-between items-center bg-home-background background-texture bg-primary bg-cover py-9 sm:py-8 text-white bg-blend-multiply gap-4 px-8 md:px-16">
